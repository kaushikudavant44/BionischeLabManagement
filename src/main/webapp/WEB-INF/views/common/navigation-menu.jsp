...
<aside id="leftsidebar" class="sidebar">
   ...
   <%--  <div class="user-info">
            ...
            <li class="accordion-toggle">
              ...
              <li class="accordion-toggle" >
                ...
                <ul class="ml-menu">
                    ...
                    <li>
                        <a  href="${pageContext.request.contextPath}/home">Jquery Datatables</a>
                    </li>
                    <li>
    ...
    <div class="legal">
        <div class="copyright">
            &copy; <fmt:formatDate value="${date}" pattern="yyyy" /> <a href="javascript:void(0);">Bionische Technology Pvt. Ltd.</a>
        </div>
    </div>
    <!-- #Footer -->
