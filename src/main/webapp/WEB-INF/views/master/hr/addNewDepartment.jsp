...
<meta
	...
	name="viewport">
<title>Add / View Department</title>
<!-- Favicon-->
...
<body class="theme-red">
	...
	<div ng-app="app">
<div class="body" ng-controller="getAllDeptController">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							...
							<h2 class="card-inside-title">ADD NEW DEPARTMENT DETAILS</h2>

						</div>
						

							<form name="newStaffForm" ng-submit="submitAddNewDeptForm()">
								<div class="row clearfix">
									...
									<div class="col-md-4">
										...
										<div class="input-group">
											...
											<div class="form-line">
												<input type="text" ng-model="deptName" id="deptName" class="form-control"
													placeholder=""> 
													<input type="hidden"  
													ng-model="deptId" class="form-control" placeholder="">
											</div>
										</div>
									</div>
...
<th>Edit</th>
 ...
 <td>
            <a ng-click="editDepartment(dept)" class="edit-button" style="cursor: pointer;">Edit</a>
            </td>
	...
	<script
		src="${pageContext.request.contextPath}/resources/ng/master/hr/departmentDetails.js"></script>
</body>
</html>