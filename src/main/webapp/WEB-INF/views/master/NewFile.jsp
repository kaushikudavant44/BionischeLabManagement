		...
		<div class="row">
			<div ng-controller="getallcustomersController" class="col-md-3">
				...
				<div ng-show="showAllCustomers">
					<ul class="list-group">
						<li ng-repeat="customer in allcustomers"><h4
								class="list-group-item">
								<strong>Customer {{$index +1}}</strong><br /> Id:
								{{customer.id}}<br /> First Name: {{customer.firstName}}<br />
			...
			<div ng-controller="getcustomersbylastnameController"
				...
				<div ng-show="showCustomersByLastName">
					...
					<ul class="list-group">
						<li ng-repeat="customer in allcustomersbylastname"><h4
								class="list-group-item">
								<strong>Customer {{$index +1}}</strong><br /> Id:
								{{customer.id}}<br /> First Name: {{customer.firstName}}<br />
								Last Name: {{customer.lastName}}
