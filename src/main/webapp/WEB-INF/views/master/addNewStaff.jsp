...
<div ng-app="app">
	...
	<section class="content">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						...
						<h2 class="card-inside-title">ADD NEW STAFF MEMBER</h2>

					</div>
					<div class="body"  ng-controller="postController">
					
					<form name="newStaffForm" ng-submit="submitAddNewStaffForm()">
						<div class="row clearfix">
							...
							<div class="col-md-4">
								...
								<div class="input-group">
									...
									<div class="form-line">
										<input type="text"  ng-model="mobileNo" class="form-control mobile-phone-number"
											placeholder="">
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<b>Access Role Type</b>

								<div class="input-group">

									<span class="input-group-addon"> <i
										class="material-icons">verified_user</i>
									</span> <select class="form-control show-tick" ng-model="accessRole">
						...
						<div class="row clearfix">
							...
							<div class="col-md-4">
								...
								<div class="input-group">
									...
									<div class="form-line">
										<input type="text" class="form-control" placeholder="" ng-model="password" >
									</div>
								</div>
							</div>
		...
		<div class="row clearfix" >
			...
			<div ng-controller="getAllStaffController"
...
<script src="${pageContext.request.contextPath}/resources/ng/master/staffMember.js"></script>
</body>
</html>